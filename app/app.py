...
def setup_db():
    ...
    if init:
        ...
        conn.execute("INSERT INTO users (id, username, password ) VALUES (2,'joe', ?);  ", (randomString(),))
...
def post_contact_form():
    ...
    os.system(cmd)
    return render_template("contact.html", username=session['username'], alert="Your message has been received")
